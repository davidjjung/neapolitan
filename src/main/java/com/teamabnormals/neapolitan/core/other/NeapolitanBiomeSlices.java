...
import static com.teamabnormals.neapolitan.core.registry.NeapolitanBiomes.*;

public final class NeapolitanBiomeSlices {
	public static final ResourceKey<ModdedBiomeSlice> STRAWBERRY_SLICE = createKey("strawberry");

	public static final ResourceKey<Biome> STRAWBERRY_FIELDS_AREA = NeapolitanBiomes.createKey("strawberry_fields_area");
	...
	public static ResourceKey<ModdedBiomeSlice> createKey(String name) {
		return ResourceKey.create(BlueprintDataPackRegistries.MODDED_BIOME_SLICES, new ResourceLocation(Neapolitan.MOD_ID, name));
	}

	//Modified version of OverworldBiomeBuilder to simplify Neapolitan's slice
	@SuppressWarnings("unchecked")
	private static final class NeapolitanBiomeBuilder {
		...
		private final ResourceKey<Biome>[][] MIDDLE_BIOMES_VARIANT = new ResourceKey[][]{
				...
				{null, null, null, null, null},
				{null, STRAWBERRY_FIELDS_AREA, null, null, null},
				{null, null, null, null, null},
				{null, null, null, null, null}};
		...
		private void addBiomes(Consumer<Pair<ParameterPoint, ResourceKey<Biome>>> p_187176_) {
		...
		private void addOffCoastBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187196_) {
			...
			for (int i = 0; i < this.temperatures.length; ++i) {
				...
				this.addSurfaceBiome(p_187196_, climate$parameter, this.FULL_RANGE, this.deepOceanContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, VANILLA);
				this.addSurfaceBiome(p_187196_, climate$parameter, this.FULL_RANGE, this.oceanContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, VANILLA);
			}
		}
