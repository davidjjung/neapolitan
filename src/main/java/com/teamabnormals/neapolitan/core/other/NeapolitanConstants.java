...
public class NeapolitanConstants {
	...
	public static final ResourceLocation IS_RAINFOREST = new ResourceLocation(ATMOSPHERIC, "is_rainforest");
	...
	public static final ResourceLocation RAINFOREST = new ResourceLocation(ATMOSPHERIC, "rainforest");
	public static final ResourceLocation RAINFOREST_BASIN = new ResourceLocation(ATMOSPHERIC, "rainforest_basin");
	public static final ResourceLocation SPARSE_RAINFOREST = new ResourceLocation(ATMOSPHERIC, "sparse_rainforest");
